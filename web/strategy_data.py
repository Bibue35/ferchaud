...
STRATEGIES = [
    ...
    {"id":97,"tier":"elite","name":"Volatility Carry (VXX vs. VXZ)","asset_class":"Volatility","category":"Income","description":"Short VXX (1M VIX futures) and long VXZ (5M VIX futures). The short end decays faster due to contango. Hedges some of the tail risk of a pure short-VIX position.","signals":["VXX vs. VXZ price ratio","Term structure slope","Realized vs. implied volatility"],"entry":"Short VXX, long VXZ in dollar-neutral ratio.","exit":"Close if VIX > 35 or ratio normalizes.","holding_period":"Weeks","risk":"High.","status":"live"},
    ...
    {"id":126,"tier":"elite","name":"Global Macro – Economic Announcement Trading","asset_class":"Global Macro","category":"Directional","description":"Trade equity index futures, bonds, or FX immediately following key economic releases (NFP, CPI, GDP, Fed decision). Position based on surprise factor = (actual − consensus estimate) / standard deviation of historical surprises.","signals":["Economic surprise index","Consensus vs. actual release","Market impact score","Intraday liquidity"],"entry":"Buy (sell) upon positive (negative) economic surprise in relevant asset.","exit":"Within same session — position held minutes to hours.","holding_period":"Minutes to hours","risk":"High — initial print sometimes revised.","status":"live"},
